...
HD_PWD='C:/Users/RWHitchins/Desktop/mandel/mandel_IP/mandel_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mandelbrot_tpg_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mandelbrot_tpg_top.tcl
