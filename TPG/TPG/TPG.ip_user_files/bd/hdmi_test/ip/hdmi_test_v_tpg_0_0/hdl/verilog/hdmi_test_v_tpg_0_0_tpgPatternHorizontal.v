...
module hdmi_test_v_tpg_0_0_tpgPatternHorizontal (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7:0] rampVal_1;
wire   [7:0] tmp_233_cast_fu_72_p2;
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_state1))) begin
        rampVal_1 <= tmp_233_cast_fu_72_p2;
    end
end
...
assign tmp_233_cast_fu_72_p2 = (Scalar_val_0_V_writ_fu_50_p3 + 8'd1);

assign tmp_fu_40_p2 = ((x == 16'd0) ? 1'b1 : 1'b0);

assign tmp_s_fu_58_p2 = ((color == 8'd0) ? 1'b1 : 1'b0);

endmodule //hdmi_test_v_tpg_0_0_tpgPatternHorizontal
