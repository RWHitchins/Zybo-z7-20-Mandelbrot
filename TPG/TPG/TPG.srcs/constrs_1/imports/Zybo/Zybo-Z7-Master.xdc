...
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { leds_4ports_tri_io[0] }]; #IO_L23P_T3_35 Sch=led[0]
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { leds_4ports_tri_io[1] }]; #IO_L23N_T3_35 Sch=led[1]
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { leds_4ports_tri_io[2] }]; #IO_0_35 Sch=led[2]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { leds_4ports_tri_io[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
...
#These max delays can be set because the multipliers in the design don't have to complete within
#one clock cycle (as extra steps in the state machine have been deliberately added to aid timing)
#set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/arg__*/CLK] -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/x2_reg[*]/D}] 15.0
#set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/arg__*/CLK] -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/xy_reg[*]/D}] 15.0
#set_max_delay -from [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/A[*]__0/C}] -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/x2_reg[*]/D}] 15.0
#set_max_delay -from [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/A[*]__0/C}] -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/y2_reg[*]/D}] 15.0
set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/*/CLK] -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/x2_reg[*]/D}] 20.0
set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/*/CLK] -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/y2_reg[*]/D}] 20.0
set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/*/C]   -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/x2_reg[*]/D}] 20.0
set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/*/C]   -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/y2_reg[*]/D}] 20.0
set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/*/CLK] -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/xy_reg[*]/D}] 20.0
set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/*/C]   -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/xy_reg[*]/D}] 20.0
set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/*/CLK] -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/act_im_reg[*]/D}] 20.0
set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/*/CLK] -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/act_re_reg[*]/D}] 20.0
set_max_delay -from [get_pins hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/psdsp_*/C] -to [get_pins {hdmi_test_i/mandelbrot_tpg_top_0/U0/UUT/act_im_reg[-*]/D}] 20.0