...
--Command     : generate_target hdmi_test_wrapper.bd
--Design      : hdmi_test_wrapper
...
end hdmi_test_wrapper;

architecture STRUCTURE of hdmi_test_wrapper is
  component hdmi_test is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
hdmi_test_i: component hdmi_test
     port map (
