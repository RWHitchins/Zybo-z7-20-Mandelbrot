...
################################################################
# This is a generated script based on design: hdmi_test
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Logic_2, and set properties
  set Logic_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 Logic_2 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1} \
  ...
  # Create instance: mandelbrot_tpg_top_0, and set properties
  set mandelbrot_tpg_top_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:mandelbrot_tpg_top:1.0 mandelbrot_tpg_top_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA2_PERIPHERAL_FREQMHZ {27} \
   CONFIG.PCW_FPGA3_PERIPHERAL_FREQMHZ {148.5} \
  ...
  connect_bd_intf_net -intf_net mandelbrot_tpg_top_0_m0_axis [get_bd_intf_pins mandelbrot_tpg_top_0/m0_axis] [get_bd_intf_pins v_tpg_0/s_axis_video]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins mandelbrot_tpg_top_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_clk_wiz_100M/interconnect_aresetn]
  connect_bd_net -net Logic_1_dout [get_bd_pins Logic_1/dout] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/s_axi_aclken]
  connect_bd_net -net Logic_2_dout [get_bd_pins Logic_2/dout] [get_bd_pins v_tpg_0/s_axis_video_TDEST] [get_bd_pins v_tpg_0/s_axis_video_TID] [get_bd_pins v_tpg_0/s_axis_video_TSTRB]
  ...
  connect_bd_net -net axi_vdma_0_s_axis_s2mm_tready [get_bd_pins axi_vdma_0/s_axis_s2mm_tready] [get_bd_pins axis_clock_converter_0/m_axis_tready]
  connect_bd_net -net axis_clock_converter_0_m_axis_tdata [get_bd_pins axi_vdma_0/s_axis_s2mm_tdata] [get_bd_pins axis_clock_converter_0/m_axis_tdata]
  connect_bd_net -net axis_clock_converter_0_m_axis_tkeep [get_bd_pins axi_vdma_0/s_axis_s2mm_tkeep] [get_bd_pins axis_clock_converter_0/m_axis_tkeep]
  connect_bd_net -net axis_clock_converter_0_m_axis_tlast [get_bd_pins axi_vdma_0/s_axis_s2mm_tlast] [get_bd_pins axis_clock_converter_0/m_axis_tlast]
  connect_bd_net -net axis_clock_converter_0_m_axis_tuser [get_bd_pins axi_vdma_0/s_axis_s2mm_tuser] [get_bd_pins axis_clock_converter_0/m_axis_tuser]
  connect_bd_net -net axis_clock_converter_0_m_axis_tvalid [get_bd_pins axi_vdma_0/s_axis_s2mm_tvalid] [get_bd_pins axis_clock_converter_0/m_axis_tvalid]
  connect_bd_net -net axis_clock_converter_0_s_axis_tready [get_bd_pins axis_clock_converter_0/s_axis_tready] [get_bd_pins v_tpg_0/m_axis_video_TREADY]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_tc_0/s_axi_aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins mandelbrot_tpg_top_0/S_AXI_ARESETN] [get_bd_pins proc_sys_reset_2/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins v_tpg_0/ap_rst_n]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins mandelbrot_tpg_top_0/S_AXI_ACLK] [get_bd_pins mandelbrot_tpg_top_0/clk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins v_tpg_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_clk_wiz_100M/ext_reset_in]
  ...
  connect_bd_net -net rst_clk_wiz_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_100M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_pins v_axi4s_vid_out_0/locked] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net v_axi4s_vid_out_0_overflow [get_bd_pins v_axi4s_vid_out_0/overflow] [get_bd_pins xlconcat_1/In2]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_underflow [get_bd_pins v_axi4s_vid_out_0/underflow] [get_bd_pins xlconcat_1/In3]
  ...
  connect_bd_net -net v_tpg_0_m_axis_video_TDATA [get_bd_pins axis_clock_converter_0/s_axis_tdata] [get_bd_pins v_tpg_0/m_axis_video_TDATA]
  connect_bd_net -net v_tpg_0_m_axis_video_TKEEP [get_bd_pins axis_clock_converter_0/s_axis_tkeep] [get_bd_pins v_tpg_0/m_axis_video_TKEEP]
  connect_bd_net -net v_tpg_0_m_axis_video_TLAST [get_bd_pins axis_clock_converter_0/s_axis_tlast] [get_bd_pins v_tpg_0/m_axis_video_TLAST]
  connect_bd_net -net v_tpg_0_m_axis_video_TUSER [get_bd_pins axis_clock_converter_0/s_axis_tuser] [get_bd_pins v_tpg_0/m_axis_video_TUSER]
  connect_bd_net -net v_tpg_0_m_axis_video_TVALID [get_bd_pins axis_clock_converter_0/s_axis_tvalid] [get_bd_pins v_tpg_0/m_axis_video_TVALID]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins Logic_0/dout] [get_bd_pins v_axi4s_vid_out_0/fid] [get_bd_pins v_axi4s_vid_out_0/vtg_field_id] [get_bd_pins v_tc_0/fsync_in]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x60000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mandelbrot_tpg_top_0/S_AXI/reg0] SEG_mandelbrot_tpg_top_0_reg0
