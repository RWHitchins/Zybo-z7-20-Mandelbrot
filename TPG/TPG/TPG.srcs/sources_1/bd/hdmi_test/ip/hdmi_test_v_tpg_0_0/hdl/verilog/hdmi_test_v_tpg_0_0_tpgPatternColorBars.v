...
module hdmi_test_v_tpg_0_0_tpgPatternColorBars (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [10:0] xBar_V_0;
wire   [0:0] tmp_64_fu_192_p2;
wire   [0:0] sel_tmp4_fu_314_p2;
reg   [0:0] sel_tmp4_reg_428;
reg    ap_block_pp0_stage0_subdone;
reg   [2:0] ap_phi_mux_hBarSel_3_0_loc_phi_fu_157_p6;
wire   [2:0] ap_phi_reg_pp0_iter0_hBarSel_3_0_loc_reg_154;
wire   [0:0] tmp_63_fu_186_p2;
wire   [0:0] tmp_80_fu_221_p2;
wire   [2:0] tmp_84_fu_245_p2;
wire   [63:0] tmp_85_fu_282_p1;
wire   [10:0] tmp_83_fu_233_p2;
wire   [10:0] tmp_81_fu_258_p2;
wire   [13:0] tmp_88_fu_166_p1;
wire   [13:0] tmp_s_fu_170_p2;
wire   [10:0] barWidth_V_fu_176_p4;
wire   [11:0] lhs_V_cast_fu_211_p1;
wire   [11:0] ret_V_fu_215_p2;
wire   [11:0] tmp_66_cast_fu_198_p1;
wire   [10:0] tmp_82_fu_227_p2;
wire   [0:0] tmp_89_fu_292_p1;
...
hdmi_test_v_tpg_0_0_tpgPatternCheckerdEe #(
    .DataWidth( 1 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
tpgBarSelRgb_r_U(
...
hdmi_test_v_tpg_0_0_tpgPatternCheckereOg #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
tpgBarSelYuv_y_U(
...
hdmi_test_v_tpg_0_0_tpgPatternCheckerfYi #(
    .DataWidth( 1 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
tpgBarSelRgb_g_U(
...
hdmi_test_v_tpg_0_0_tpgPatternCheckerg8j #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
tpgBarSelYuv_v_U(
...
hdmi_test_v_tpg_0_0_tpgPatternCheckerhbi #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
tpgBarSelYuv_u_U(
...
hdmi_test_v_tpg_0_0_tpgPatternCheckeribs #(
    .DataWidth( 1 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
tpgBarSelRgb_b_U(
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_48)) begin
        if ((tmp_63_fu_186_p2 == 1'd1)) begin
            hBarSel_3_0 <= 3'd0;
        end else if (((tmp_80_fu_221_p2 == 1'd0) & (tmp_63_fu_186_p2 == 1'd0))) begin
            hBarSel_3_0 <= tmp_84_fu_245_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_48)) begin
        if ((tmp_63_fu_186_p2 == 1'd1)) begin
            xBar_V_0 <= 11'd0;
        end else if (((tmp_80_fu_221_p2 == 1'd1) & (tmp_63_fu_186_p2 == 1'd0))) begin
            xBar_V_0 <= tmp_81_fu_258_p2;
        end else if (((tmp_80_fu_221_p2 == 1'd0) & (tmp_63_fu_186_p2 == 1'd0))) begin
            xBar_V_0 <= tmp_83_fu_233_p2;
        end
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_25)) begin
        if (((tmp_80_fu_221_p2 == 1'd0) & (tmp_63_fu_186_p2 == 1'd0))) begin
            ap_phi_mux_hBarSel_3_0_loc_phi_fu_157_p6 = tmp_84_fu_245_p2;
        end else if (((tmp_80_fu_221_p2 == 1'd1) & (tmp_63_fu_186_p2 == 1'd0))) begin
            ap_phi_mux_hBarSel_3_0_loc_phi_fu_157_p6 = hBarSel_3_0;
        end else if ((tmp_63_fu_186_p2 == 1'd1)) begin
            ap_phi_mux_hBarSel_3_0_loc_phi_fu_157_p6 = 3'd0;
        end else begin
            ap_phi_mux_hBarSel_3_0_loc_phi_fu_157_p6 = ap_phi_reg_pp0_iter0_hBarSel_3_0_loc_reg_154;
        end
    end else begin
        ap_phi_mux_hBarSel_3_0_loc_phi_fu_157_p6 = ap_phi_reg_pp0_iter0_hBarSel_3_0_loc_reg_154;
    end
...
assign Scalar_val_0_V_writ_fu_328_p3 = ((tmp_64_fu_192_p2[0:0] === 1'b1) ? tpgBarSelRgb_r_load_s_fu_320_p3 : tpgBarSelYuv_y_q0);

assign Scalar_val_1_V_writ_fu_350_p3 = ((sel_tmp4_reg_428[0:0] === 1'b1) ? tpgBarSelYuv_v_q0 : sel_tmp_fu_343_p3);

assign Scalar_val_2_V_writ_fu_365_p3 = ((tmp_64_fu_192_p2[0:0] === 1'b1) ? tpgBarSelRgb_b_load_s_fu_357_p3 : tpgBarSelYuv_v_q0);
...
assign ap_phi_reg_pp0_iter0_hBarSel_3_0_loc_reg_154 = 'bx;
...
assign sel_tmp1_fu_296_p2 = (tmp_64_fu_192_p2 ^ 1'd1);

assign sel_tmp2_fu_302_p2 = ((color != 8'd1) ? 1'b1 : 1'b0);

assign sel_tmp4_fu_314_p2 = (tmp_fu_308_p2 & sel_tmp2_fu_302_p2);

assign sel_tmp_fu_343_p3 = ((tmp_64_fu_192_p2[0:0] === 1'b1) ? tpgBarSelRgb_g_load_s_fu_335_p3 : tpgBarSelYuv_u_q0);

assign tmp_63_fu_186_p2 = ((x == 16'd0) ? 1'b1 : 1'b0);

assign tmp_64_fu_192_p2 = ((color == 8'd0) ? 1'b1 : 1'b0);

assign tmp_66_cast_fu_198_p1 = barWidth_V_fu_176_p4;

assign tmp_80_fu_221_p2 = ((ret_V_fu_215_p2 < tmp_66_cast_fu_198_p1) ? 1'b1 : 1'b0);

assign tmp_81_fu_258_p2 = (xBar_V_0 + 11'd1);

assign tmp_82_fu_227_p2 = (11'd1 - barWidth_V_fu_176_p4);

assign tmp_83_fu_233_p2 = (xBar_V_0 + tmp_82_fu_227_p2);

assign tmp_84_fu_245_p2 = (hBarSel_3_0 + 3'd1);

assign tmp_85_fu_282_p1 = ap_phi_mux_hBarSel_3_0_loc_phi_fu_157_p6;

assign tmp_88_fu_166_p1 = width[13:0];

assign tmp_89_fu_292_p1 = x[0:0];

assign tmp_fu_308_p2 = (tmp_89_fu_292_p1 & sel_tmp1_fu_296_p2);

assign tmp_s_fu_170_p2 = (14'd7 + tmp_88_fu_166_p1);

assign tpgBarSelRgb_b_address0 = tmp_85_fu_282_p1;

assign tpgBarSelRgb_b_load_s_fu_357_p3 = ((tpgBarSelRgb_b_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign tpgBarSelRgb_g_address0 = tmp_85_fu_282_p1;

assign tpgBarSelRgb_g_load_s_fu_335_p3 = ((tpgBarSelRgb_g_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign tpgBarSelRgb_r_address0 = tmp_85_fu_282_p1;

assign tpgBarSelRgb_r_load_s_fu_320_p3 = ((tpgBarSelRgb_r_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign tpgBarSelYuv_u_address0 = tmp_85_fu_282_p1;

assign tpgBarSelYuv_v_address0 = tmp_85_fu_282_p1;

assign tpgBarSelYuv_y_address0 = tmp_85_fu_282_p1;

endmodule //hdmi_test_v_tpg_0_0_tpgPatternColorBars
